...
> This part is not officially part of the proposal, I put in because it may be interesting to directly allow applying a ternary on container types, but that is proably something that is not tackled for this first proposal. For example this might be useful: 
