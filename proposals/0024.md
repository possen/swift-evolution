...
One are of improvement is to be able to switch on the value or key. I am open to suggestions on how to best accomplish that. 
...
* You could not simply put it in a function argument etc the way you can with the ternary operator. 
...
* I was pretty sure it would be rejected by the community because it was different but not necesarily better than the ternay operator, I believe this proposal is better than the existing ternary, due to the support for muliple types and more flexibilty.  


Once again, that was the original thought but it 
