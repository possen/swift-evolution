...
Of note, one might think that for a boolean false is first but in this true is first because that is most compatible and natural with the existing ternary. One advantage of this format is that the parenthesis help group the ternary which I believe is one complaint with the original ternary operator. 
