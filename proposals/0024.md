...
* It is easily chained, the results of the previous call can be passed through to the next function. 
...
x = x == y ? 49 : 3 
```
It is not until you get to the question mark that you realize it is a ternary and the x == y just is kind of floating there. The = and == just looks strange. Many do add parenthesis to make it look better:
...
``` swift 
  ...
  ```
This allows very concise way of picking amoung several choice.
