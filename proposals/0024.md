...
The following is how you typically would write code to assign result from an enum, in this case a enum of three or more colors: 
...
With this proposal the repeated code is eliminated, it concisely allow assignement and use type inference to bind to determine the type and bind the name. 
...
In addition to supporting enums any enumerable type is supported with these forms:

``` swift 
  character = ?(charNum : "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", "K", default:"Z")
```

This is a bit contrived, there are possibly better ways to do this. For ranges:
