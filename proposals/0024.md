...
As an alternative **else** can be used here if this reads better. This may depend on the situation. Some who are not fans of the original ternary can use this form and with the above form, the conciseness is preserved. 
